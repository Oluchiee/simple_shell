 ...
 * Return: 0 if no Nos in string, convert number otherwise -1 on error
 */
int _erratoi(char *s)
{
	int i = 0;
 ...
 * Return: 0 if no No in string, convert number otherwise -1 on error
 */
...
/**
 * print_d - this is the function that prints a decimal (integer) number (base 10)
 * @input: input
