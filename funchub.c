...
/**
 * _myhistory -this displays  history list, a command by a line, follow with line numbers, starting at 0.
 * @info: Struc contain potential arguments. Used to maintain constant function prototype.
 *  Return: Always 0
 */
